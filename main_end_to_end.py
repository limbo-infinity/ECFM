...
from train import train_end_to_end_fixed_q_bid
from virtual_trading_simulator import evaluate_fixed_q_bid_policy
...
if __name__ == "__main__":
    ...
    config = {
        ...
        "decision_model": {
            ...
            "budget_constraint": "sum(abs(bid_price)) <= budget for each day",
